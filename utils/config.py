...
class Config:
    ...
    ######## Logic Augmentation parameters
    logic_augmentation_prob = 0.5  # Probability of applying augmentation
    minority_class_threshold = 0.1  # Threshold to define minority classes
    rotation_prob = 0.5
    ...
    def save(self):
        ...
        with open(join(self.saving_path, 'parameters.txt'), "w") as text_file:
            ...
            if type(self.num_classes) is list:
                ...
                print("Saving num_classes:", self.num_classes)
